...
<html lang="en">
  <head>
    ...
    <title>UTS PBW - Web Frizshop</title>
  ...
  <body>
    ...
    <!-- Javascript -->
    <script src="script.js"></script>        <!-- Product actions-->
                        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                            <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="detail.php?idp=<?php echo $p['id_produk']?>">Lihat</a>
                            </div>
                        </div>
                    </div>
                </div>
