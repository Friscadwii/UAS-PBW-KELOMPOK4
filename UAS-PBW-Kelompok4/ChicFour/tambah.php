  ...
  <body>
    ...
    <section class="jumbotroon pad" id="sewa" style="padding-top: 5rem; padding-bottom: 16rem;">
      <div class="card mx-auto" style="width: 60rem">
        <h3 class="card-header text-center fw-bolder">Tambah Data Kategori</h3>
        <div class="card-body">
          <form action="" method="POST">
            <div class="row mb-3">
              <label for="namak" class="col-sm-3 col-form-label">Nama Kategori</label>
              <div class="col-sm-9">
                <input type="text" name="namak" class="form-control" id="namak" value="" required />
              </div>
            </div>
          ...
          <?php
            if(isset($_POST['tambah'])){
              ...
              if($insert){
                ...
                echo '<script>alert("Tambah Data Gagal")</script>', mysqli_error($koneksi);
              }
            }
          ?>
        </div>
