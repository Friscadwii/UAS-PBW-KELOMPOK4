  ...
  <body>
    ...
    <section class="jumbotroon pad" id="sewa" style="padding-top: 5rem; padding-bottom: 1rem;">
      <div class="card mx-auto" style="width: 80rem">
        <h3 class="card-header text-center fw-bolder">Produk</h3>
        <div class="card-body">
          <a class="btn btn-primary text-light" href="tambah-produk.php">Tambah Produk</a>
            ...
            <table class="table table-bordered border-dark">
              ...
              <tbody>
                  ...
                  <tr class="text-center">
                    ...
                    <td class="align-middle"><?php echo ($row['status'] == 0)? 'Tidak Aktif':'Aktif'; ?></td>
                    <td class="align-middle"><a href="img/<?php echo $row['foto'] ?>" target="_blank"><img src="img/<?php echo $row['foto'] ?>" width="100px"></a></td>
                    <td class="align-middle"><a class="btn btn-outline-danger" href="edit-produk.php?idp=<?php echo $row['id_produk']?>">Edit</a>
                    <a class="btn btn-danger text-light" href="hapus.php?idp=<?php echo $row['id_produk']?>" onclick="return confirm('Yakin ingin hapus?')">Hapus</a></td>
                  </tr>
